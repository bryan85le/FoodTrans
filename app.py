...
# Create Drawer
nav_links = [
    DrawerSingleItem(name="Login", icon="bx:log-in", href="/login"),
    DrawerSingleItem(name="Page 1", icon="bx:scatter-chart", href="/page1"),
    DrawerMultiItem(
        name="Page2",
        icon="bx:line-chart",
        href="/page2/subpage1",
        submenu=[
            DrawerSubItem(name="Subpage 1", href="/page2/subpage1"),
            DrawerSubItem(name="Subpage 2", href="/page2/subpage2"),
        ],
    ),
    DrawerFooter(title="Footer", subtitle="Footer Subtitle"),
]
